...
class SphinxClient
{
	...
	/**
	 * 更新文档的属性，不能用来更新索引值
	 * 使用UpdateAttributes()API调用更新的属性值将一直保存在内存中，直到一次这样的刷新->FlushAttributes()
	 * @param unknown $index
	 * @param unknown $attrs
	 * @param unknown $values
	 * @param string $type 默认为整型，SPH_UPDATE_STRING和SPH_UPDATE_JSON是一样的
	 * @param string $ignorenonexistent
